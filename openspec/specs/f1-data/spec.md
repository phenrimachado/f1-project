...
## Purpose
Sincronizar dados essenciais de Formula 1 (meetings, sessions, drivers,
laps) a partir da OpenF1 API publica, persistir localmente, e expor via
endpoints REST proprios com cache Redis.
